function  [non_zero, error] = weight_decay2(TrainData, TrainDataTargets, TestData, TestDataTargets, architecture, activation, learn_rate, training, learning)
%d = threshold
...
net = newff(TrainD, TrainDT, architecture, {'tansig', activation}, training, learning);
